...
use crate::{lookup, cq_lookup, permutation, shuffle};
use ff::Field;
...
pub struct ConstraintSystemMid<F: Field> {
	...
	// Similarly cq_lookup arguments
	pub cq_lookups: Vec<cq_lookup::ArgumentMid<F>>,

	// Vector of cq_arguments
	//pub cq_lookups: Vec<cq_lookup::Argument<F>>,
