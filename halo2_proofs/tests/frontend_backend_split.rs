...
fn test_mycircuit_full_legacy() {
    ...
    create_proof::<KZGCommitmentScheme<Bn256>, ProverSHPLONK<'_, Bn256>, _, _, _, _, CqProverSchemeKzg<Bn256, Challenge255<_>, Blake2bWrite<Vec<u8>,_,Challenge255<_>>> >(
        &params,
        &pk,
        &[circuit],
        &[instances_slice],
    ...
    verify_proof::<KZGCommitmentScheme<Bn256>, VerifierSHPLONK<'_, Bn256>, _, _, _, CqVerifierSchemeKzg::<Bn256, Challenge255<G1Affine>, Blake2bRead<_,_,Challenge255<_>>> >(
        &params,
        &vk,
        strategy,
        &[instances_slice],
